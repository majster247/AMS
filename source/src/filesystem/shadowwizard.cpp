...
bool myos::filesystem::FileIf(uint32_t sector) {

	AdvancedTechnologyAttachment ata0m(0x1F0, true);

	uint8_t file[4];
	ata0m.AdvancedTechnologyAttachment::Read28(sector, file, 4, 0);
...
//32 bit FNV-1a hash
uint32_t myos::filesystem::fnv1a(char* str) {
...
uint32_t myos::filesystem::GetFileSize(char* name) {
...
uint32_t myos::filesystem::AddTable(char* name) {
...
uint32_t myos::filesystem::RemoveTable(char* name) {
...
bool myos::filesystem::NewFile(char* name, uint8_t* file, uint32_t size) {
...
bool myos::filesystem::WriteFile(char* name, uint8_t* file, uint32_t size) {
...
bool myos::filesystem::WriteLBA(char* name, uint8_t* file, uint32_t lba) {
...
bool myos::filesystem::ReadFile(char* name, uint8_t* file, uint32_t size) {
...
bool myos::filesystem::ReadLBA(char* name, uint8_t* file, uint32_t lba) {
...
bool myos::filesystem::DeleteFile(char* name) {
